...
func TestLoadConfig(t *testing.T) {
	...
	tests := []struct {
		...
		{
			id: component.NewIDWithName(component.MustNewType("clientmetadata"), "insert"),
			expected: &Config{
		...
		{
			id: component.NewIDWithName(component.MustNewType("clientmetadata"), "update"),
			expected: &Config{
				Actions: []actions.KeyValue{
		...
		{
			id: component.NewIDWithName(component.MustNewType("clientmetadata"), "upsert"),
			expected: &Config{
				Actions: []actions.KeyValue{
		...
		{
			id: component.NewIDWithName(component.MustNewType("clientmetadata"), "delete"),
			expected: &Config{
				Actions: []actions.KeyValue{
		...
		{
			id: component.NewIDWithName(component.MustNewType("clientmetadata"), "mixed"),
			expected: &Config{
				Actions: []actions.KeyValue{
